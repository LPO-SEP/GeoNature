...
cp ./sensibles_to_inpn_20201218.csv /tmp
...
COPY gn_sensitivity.tmp_rules FROM '/tmp/sensibles_to_inpn_20201218.csv' DELIMITER ';' CSV HEADER;
"
...
select t.cd_nom, t.nom_cite , ref_nomenclatures.get_id_nomenclature('SENSIBILITE', codage::varchar)  , coalesce(t.duree, 10000) , 'Département', t.cd_dept, null, null, 'Fichier Solene issu BDC', true, null
